(() => {
  ...
  var identifiers = new import_lr.ExternalTokenizer(
    identifierTokens(identifier, VariableName, callee),
    { contextual: true }
  );
  var queryIdentifiers = new import_lr.ExternalTokenizer(
  ...
  var parser = import_lr.LRParser.deserialize({
    ...
    tokenizers: [descendant, unitToken, identifiers, queryIdentifiers, 1, 2, 3, 4, new import_lr.LocalTokenGroup("m~RRYZ[z{a~~g~aO$c~~dP!P!Qg~lO$d~~", 28, 156)],
  ...
  // js/entries/lang_css.js
  globalThis.__CM__lang_css = dist_exports2;
  globalThis.__CM__lezer_css = dist_exports;
})();
