...
(** {{:https://codemirror.net/docs/ref/#commands.historyField}
    ...
    Left as a raw handle: unlike a field created with
    {!Cm_state.StateField.define}, there is no public way to wrap a
    JavaScript-defined field as a typed {!Cm_state.StateField.t}, and this
