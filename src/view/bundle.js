(() => {
  ...
  var Decoration = class extends import_state.RangeValue {
    ...
    */
    static set(of, sort = false) {
      return import_state.RangeSet.of(of, sort);
    }
    /**
    @internal
    */
  ...
  Decoration.none = import_state.RangeSet.empty;
  ...
  LineDecoration.prototype.mapMode = import_state.MapMode.TrackBefore;
  ...
  var PointDecoration = class _PointDecoration extends Decoration {
    constructor(spec, startSide, endSide, block, widget, isReplace) {
      ...
      this.mapMode = !block ? import_state.MapMode.TrackDel : startSide <= 0 ? import_state.MapMode.TrackBefore : import_state.MapMode.TrackAfter;
    }
  ...
  var BlockWrapper = class _BlockWrapper extends import_state.RangeValue {
  ...
  function moveVisually(line, order, dir, start, forward) {
    ...
    let nextIndex = (0, import_state.findClusterBreak)(line.text, startIndex, span.forward(forward, dir));
    ...
    if (nextIndex == spanEnd) {
      if (!nextSpan)
        return forward ? import_state.EditorSelection.cursor(line.to, 1) : import_state.EditorSelection.cursor(line.from, -1);
      if (nextSpan.level + (forward ? 0 : 1) < span.level)
        return import_state.EditorSelection.cursor(nextSpan.side(!forward, dir) + line.from, nextSpan.forward(forward, dir) ? 1 : -1, nextSpan.level);
    }
    return import_state.EditorSelection.cursor(nextIndex + line.from, span.forward(forward, dir) ? -1 : 1, span.level);
  }
  ...
  var clickAddsSelectionRange = /* @__PURE__ */ import_state.Facet.define();
  var dragMovesSelection$1 = /* @__PURE__ */ import_state.Facet.define();
  var mouseSelectionStyle = /* @__PURE__ */ import_state.Facet.define();
  var exceptionSink = /* @__PURE__ */ import_state.Facet.define();
  var updateListener = /* @__PURE__ */ import_state.Facet.define();
  var inputHandler = /* @__PURE__ */ import_state.Facet.define();
  var focusChangeEffect = /* @__PURE__ */ import_state.Facet.define();
  var clipboardInputFilter = /* @__PURE__ */ import_state.Facet.define();
  var clipboardOutputFilter = /* @__PURE__ */ import_state.Facet.define();
  var perLineTextDirection = /* @__PURE__ */ import_state.Facet.define({
    combine: (values) => values.some((x) => x)
  });
  var nativeSelectionHidden = /* @__PURE__ */ import_state.Facet.define({
    combine: (values) => values.some((x) => x)
  });
  var scrollHandler = /* @__PURE__ */ import_state.Facet.define();
  var ScrollTarget = class _ScrollTarget {
    ...
    clip(state) {
      return this.range.to <= state.doc.length ? this : new _ScrollTarget(import_state.EditorSelection.cursor(state.doc.length), this.y, this.x, this.yMargin, this.xMargin, this.isSnapshot);
    }
  };
  var scrollIntoView = /* @__PURE__ */ import_state.StateEffect.define({ map: (t, ch) => t.map(ch) });
  var setEditContextFormatting = /* @__PURE__ */ import_state.StateEffect.define();
  ...
  var editable = /* @__PURE__ */ import_state.Facet.define({ combine: (values) => values.length ? values[0] : true });
  var nextPluginID = 0;
  var viewPlugin = /* @__PURE__ */ import_state.Facet.define({
    combine(plugins) {
  ...
  var editorAttributes = /* @__PURE__ */ import_state.Facet.define();
  var contentAttributes = /* @__PURE__ */ import_state.Facet.define();
  var decorations = /* @__PURE__ */ import_state.Facet.define();
  var blockWrappers = /* @__PURE__ */ import_state.Facet.define();
  var outerDecorations = /* @__PURE__ */ import_state.Facet.define();
  var atomicRanges = /* @__PURE__ */ import_state.Facet.define();
  var bidiIsolatedRanges = /* @__PURE__ */ import_state.Facet.define();
  function getIsolatedRanges(view, line) {
    ...
    let result = [];
    import_state.RangeSet.spans(sets, line.from, line.to, {
      point() {
      },
  ...
  var scrollMargins = /* @__PURE__ */ import_state.Facet.define();
  ...
  var styleModule = /* @__PURE__ */ import_state.Facet.define();
  ...
  var ViewUpdate = class _ViewUpdate {
    constructor(view, state, transactions) {
      ...
      this.changes = import_state.ChangeSet.empty(this.startState.doc.length);
  ...
  var WidgetTile = class _WidgetTile extends Tile {
    ...
    get overrideDOMText() {
      if (!this.length)
        return import_state.Text.empty;
      let { root } = this;
      if (!root)
        return import_state.Text.empty;
  ...
  var TileUpdate = class {
    constructor(view, old, blockWrappers2, decorations2, disallowBlockEffectsFor) {
      ...
      this.builder = new TileBuilder(this.cache, new DocTile(view, view.contentDOM), import_state.RangeSet.iter(blockWrappers2));
      this.cache.reused.set(
        old,
        2
        /* Reused.DOM */
    ...
    emit(from, to) {
      ...
      let openEnd = import_state.RangeSet.spans(this.decorations, from, to, {
  ...
  var DocView = class {
    ...
    coordsForChar(pos) {
      ...
      function scan(tile2, offset2) {
        if (tile2.isComposite()) {
          ...
          let end = (0, import_state.findClusterBreak)(tile2.text, offset2);
          if (end == offset2)
            return null;
    ...
    updateDeco() {
      ...
      if (outerDeco.length) {
        ...
        allDeco.push(import_state.RangeSet.join(outerDeco));
      }
      this.decorations = [
  ...
  function findChangedDeco(a, b, diff) {
    ...
    import_state.RangeSet.compare(a, b, diff, comp);
    return comp.changes;
  }
  ...
  function groupAt(state, pos, bias = 1) {
    ...
    if (line.length == 0)
      return import_state.EditorSelection.cursor(pos);
    if (linePos == 0)
      bias = 1;
    ...
    if (bias < 0)
      from = (0, import_state.findClusterBreak)(line.text, linePos, false);
    else
      to = (0, import_state.findClusterBreak)(line.text, linePos);
    let cat = categorize(line.text.slice(from, to));
    while (from > 0) {
      let prev = (0, import_state.findClusterBreak)(line.text, from, false);
      if (categorize(line.text.slice(prev, from)) != cat)
        break;
      from = prev;
    }
    while (to < line.length) {
      let next = (0, import_state.findClusterBreak)(line.text, to);
      if (categorize(line.text.slice(to, next)) != cat)
        break;
      to = next;
    }
    return import_state.EditorSelection.undirectionalRange(from + line.from, to + line.from);
  }
  function posAtCoordsImprecise(view, contentRect, block, x, y) {
    ...
    return block.from + (0, import_state.findColumn)(content, into, view.state.tabSize);
  }
  ...
  function moveToLineBoundary(view, start, forward, includeWrap) {
    ...
    if (coords) {
      ...
      if (pos != null)
        return import_state.EditorSelection.cursor(pos, forward ? -1 : 1);
    }
    return import_state.EditorSelection.cursor(forward ? block.to : block.from, forward ? -1 : 1);
  }
  function moveByChar(view, start, forward, by) {
    ...
    for (let cur = start, check = null; ; ) {
      ...
      if (!next) {
        ...
        next = forward ? import_state.EditorSelection.cursor(line.from, -1) : import_state.EditorSelection.cursor(line.to, 1);
      }
      if (!check) {
        if (!by)
          return next;
  ...
  function byGroup(view, pos, start) {
    ...
    return (next) => {
      ...
      if (cat == import_state.CharCategory.Space)
        cat = nextCat;
      return cat == nextCat;
    };
  }
  function moveVertically(view, start, forward, distance) {
    ...
    if (startPos == (forward ? view.state.doc.length : 0))
      return import_state.EditorSelection.cursor(startPos, start.assoc);
    ...
    for (let scan = 0; ; scan += halfText) {
      ...
      if (forward ? y > rect.bottom : y < rect.top)
        return import_state.EditorSelection.cursor(pos.pos, pos.assoc);
      ...
      if (!posCoords || (forward ? mid > startY : mid < startY))
        return import_state.EditorSelection.cursor(pos.pos, pos.assoc, void 0, goal);
    }
  }
  ...
  function skipAtomsForSelection(atoms, sel) {
    ...
    for (let i = 0; i < sel.ranges.length; i++) {
      ...
      if (range.empty) {
        ...
        if (pos != range.from)
          updated = import_state.EditorSelection.cursor(pos, -1);
      } else {
        let from = skipAtomicRanges(atoms, range.from, -1);
        let to = skipAtomicRanges(atoms, range.to, 1);
        if (from != range.from || to != range.to) {
          if (range.undirectional)
            updated = import_state.EditorSelection.undirectionalRange(range.from, range.to);
          else
            updated = import_state.EditorSelection.range(range.from == range.anchor ? from : to, range.from == range.head ? from : to);
        }
      }
      if (updated) {
        if (!ranges)
    ...
    return ranges ? import_state.EditorSelection.create(ranges, sel.mainIndex) : sel;
  }
  function skipAtoms(view, oldPos, pos) {
    let newPos = skipAtomicRanges(view.state.facet(atomicRanges).map((f) => f(view)), pos.from, oldPos.head > pos.from ? -1 : 1);
    return newPos == pos.from ? pos : import_state.EditorSelection.cursor(newPos, newPos < pos.from ? 1 : -1);
  }
  var PosAssoc = class {
  ...
  var InlineCoordsScan = class {
    ...
    scanText(tile, offset) {
      let positions = [];
      for (let i = 0; i < tile.length; i = (0, import_state.findClusterBreak)(tile.text, i))
  ...
  var DOMReader = class {
    constructor(points, view) {
      ...
      this.view = view;
      this.text = "";
      this.lineSeparator = view.state.facet(import_state.EditorState.lineSeparator);
    }
    append(text) {
      this.text += text;
    }
    ...
    constructor(view, start, end, typeOver) {
      ...
      if (view.state.readOnly && start > -1) {
        ...
        if (view.inputState.composing > -1 && curSel.ranges.length > 1) {
          this.newSel = curSel.replaceRange(import_state.EditorSelection.range(anchor, head));
          ...
          this.newSel = import_state.EditorSelection.create([import_state.EditorSelection.cursor(head, assoc)]);
        } else {
          this.newSel = import_state.EditorSelection.single(anchor, head);
        }
      }
    }
  };
  ...
  function applyDOMChange(view, domChange) {
    ...
    if (domChange.bounds) {
      ...
      if (!sel.empty && sel.from >= from && sel.to <= to && (domChange.typeOver || cmp != domChange.text) && cmp.slice(0, sel.from - from) == domChange.text.slice(0, sel.from - from) && cmp.slice(sel.to - from) == domChange.text.slice(selEnd = domChange.text.length - (cmp.length - (sel.to - from)))) {
        change = {
          from: sel.from,
          to: sel.to,
          insert: import_state.Text.of(domChange.text.slice(sel.from - from, selEnd).split(LineBreakPlaceholder))
        };
        ...
        change = {
          from: from + diff.from,
          to: from + diff.toA,
          insert: import_state.Text.of(domChange.text.slice(diff.from, diff.toB).split(LineBreakPlaceholder))
        };
      }
    ...
    if ((browser.mac || browser.android) && change && change.from == change.to && change.from == sel.head - 1 && /^\. ?$/.test(change.insert.toString()) && view.contentDOM.getAttribute("autocorrect") == "off") {
      if (newSel && change.insert.length == 2)
        newSel = import_state.EditorSelection.single(newSel.main.anchor - 1, newSel.main.head - 1);
      change = { from: change.from, to: change.to, insert: import_state.Text.of([change.insert.toString().replace(".", " ")]) };
      ...
      if (newSel)
        newSel = import_state.EditorSelection.single(newSel.main.anchor - 1, newSel.main.head - 1);
      change = { from: sel.from, to: sel.to, insert: import_state.Text.of([" "]) };
    }
    if (change) {
  ...
  function applyDefaultInsert(view, change, newSel) {
    ...
    if (inAtomic > -1) {
      tr = {
        changes: change,
        selection: import_state.EditorSelection.cursor(change.from + change.insert.length, -1)
      };
      ...
      if (startState.selection.ranges.length > 1 && (view.inputState.composing >= 0 || view.inputState.compositionPendingChange) && change.to <= sel.to + 10 && change.to >= sel.to - 10) {
        ...
        tr = startState.changeByRange((range) => {
          ...
          return {
            ...
            range: !mainSel ? range.map(rangeChanges) : import_state.EditorSelection.range(Math.max(0, mainSel.anchor + selOff), Math.max(0, mainSel.head + selOff))
          };
        });
      } else {
        tr = {
  ...
  function selectionFromPoints(points, base2) {
    ...
    return anchor < 0 || head < 0 ? null : anchor == head ? import_state.EditorSelection.create([import_state.EditorSelection.cursor(head + base2, -1)]) : import_state.EditorSelection.single(anchor + base2, head + base2);
  }
  ...
  var MouseSelection = class {
    constructor(view, startEvent, style, mustSelect) {
      ...
      this.multiple = view.state.facet(import_state.EditorState.allowMultipleSelections) && addsSelectionRange(view, startEvent);
    ...
    if (linewise) {
      ...
      changes = state.changeByRange((range) => {
        ...
        return {
          ...
          range: import_state.EditorSelection.cursor(range.from + insert.length, -1)
        };
      });
    } else if (byLine) {
      changes = state.changeByRange((range) => {
        ...
        return {
          ...
          range: import_state.EditorSelection.cursor(range.from + line.length, -1)
        };
      });
    } else {
  ...
  function rangeForClick(view, pos, bias, type) {
    if (type == 1) {
      return import_state.EditorSelection.cursor(pos, bias);
    } else if (type == 2) {
      ...
      if (to < view.state.doc.length && to == line.to)
        to++;
      return import_state.EditorSelection.undirectionalRange(from, to);
    }
  }
    ...
    return {
      ...
      get(event2, extend, multiple) {
        ...
        if (start.pos != cur.pos && !extend) {
          ...
          range = from < range.from ? import_state.EditorSelection.range(from, to, range.assoc) : import_state.EditorSelection.range(to, from, range.assoc);
        }
        if (extend)
          ...
          return import_state.EditorSelection.create([range]);
      }
    };
  }
  function removeRangeAround(sel, pos) {
    for (let i = 0; i < sel.ranges.length; i++) {
      ...
      if (from <= pos && to >= pos)
        return import_state.EditorSelection.create(sel.ranges.slice(0, i).concat(sel.ranges.slice(i + 1)), sel.mainIndex == i ? 0 : sel.mainIndex - (sel.mainIndex > i ? 1 : 0));
    }
    return null;
  }
    ...
    if (event.target.draggable) {
      ...
      if (tile && tile.isWidget()) {
        ...
        if (from >= range.to || to <= range.from)
          range = import_state.EditorSelection.undirectionalRange(from, to);
      }
    }
    let { inputState } = view;
  ...
  var isFocusChange = /* @__PURE__ */ import_state.Annotation.define();
  ...
  var HeightOracle = class {
    constructor(lineWrapping) {
      ...
      this.doc = import_state.Text.empty;
      this.heightSamples = {};
      this.lineHeight = 14;
      this.charWidth = 7;
      this.textHeight = 14;
  ...
  var NodeBuilder = class _NodeBuilder {
    ...
    static build(oracle, decorations2, from, to) {
      ...
      import_state.RangeSet.spans(decorations2, from, to, builder, 0);
      return builder.finish(from);
    }
  };
  function heightRelevantDecoChanges(a, b, diff) {
    let comp = new DecorationComparator2();
    import_state.RangeSet.compare(a, b, diff, comp, 0);
    return comp.changes;
  }
  ...
  var ViewState = class {
    constructor(view, state) {
      ...
      this.heightMap = HeightMap.empty().applyChanges(this.stateDeco, import_state.Text.empty, this.heightOracle.setDoc(state.doc), [new ChangedRange(0, 0, 0, state.doc.length)]);
      for (let i = 0; i < 2; i++) {
    ...
    update(update, scrollTarget = null) {
      ...
      let heightChanges = ChangedRange.extendWithRanges(contentChanges, heightRelevantDecoChanges(prevDeco, this.stateDeco, update ? update.changes : import_state.ChangeSet.empty(this.state.doc.length)));
    ...
    measure() {
      ...
      if (measureContent) {
        ...
        for (let vp of this.viewports) {
          ...
          this.heightMap = (refresh ? HeightMap.empty().applyChanges(this.stateDeco, import_state.Text.empty, this.heightOracle, [new ChangedRange(0, 0, 0, view.state.doc.length)]) : this.heightMap).updateHeight(oracle, 0, refresh, new MeasuredHeights(vp.from, heights));
        }
        if (heightChangeFlag)
          result |= 2;
      }
      ...
      let addGap = (from, to, line, structure) => {
        ...
        if (!gap) {
          if (to < line.to && mayMeasure && wrapping && mayMeasure.visibleRanges.some((r) => r.from <= to && r.to >= to)) {
            let lineStart = mayMeasure.moveToLineBoundary(import_state.EditorSelection.cursor(to), false, true).head;
            if (lineStart > from)
              to = lineStart;
          }
    ...
    computeVisibleRanges(changes) {
      ...
      let ranges = [];
      import_state.RangeSet.spans(deco, this.viewport.from, this.viewport.to, {
        span(from, to) {
          ranges.push({ from, to });
        },
        point() {
  ...
  function lineStructure(from, to, stateDeco) {
    ...
    import_state.RangeSet.spans(stateDeco, from, to, {
      span() {
      },
      point(from2, to2) {
        if (from2 > pos) {
  ...
  function staticDeco(state) {
    ...
    if (outer.length)
      deco.push(import_state.RangeSet.join(outer));
    return deco;
  }
  ...
  var theme = /* @__PURE__ */ import_state.Facet.define({ combine: (strs) => strs.join(" ") });
  var darkTheme = /* @__PURE__ */ import_state.Facet.define({ combine: (values) => values.indexOf(true) > -1 });
  ...
  var EditContextManager = class {
    constructor(view) {
      ...
      this.handlers.textupdate = (e) => {
        ...
        if (!diff) {
          let newSel = import_state.EditorSelection.single(this.toEditorPos(e.selectionStart), this.toEditorPos(e.selectionEnd));
        ...
        let change = {
          from: diff.from + from,
          to: diff.toA + from,
          insert: import_state.Text.of(e.text.slice(diff.from, diff.toB).split("\n"))
        };
        if ((browser.mac || browser.android) && change.from == head - 1 && /^\. ?$/.test(e.text) && view.contentDOM.getAttribute("autocorrect") == "off")
          change = { from, to, insert: import_state.Text.of([e.text.replace(".", " ")]) };
        this.pendingContextChange = change;
        if (!view.state.readOnly) {
          let newLen = this.to - this.from + (change.to - change.from + change.insert.length);
          applyDOMChangeInner(view, change, import_state.EditorSelection.single(this.toEditorPos(e.selectionStart, newLen), this.toEditorPos(e.selectionEnd, newLen)));
        }
  ...
  var EditorView = class _EditorView {
    ...
    */
    constructor(config = {}) {
      ...
      this.viewState = new ViewState(this, config.state || import_state.EditorState.create(config));
    ...
    dispatch(...input) {
      let trs = input.length == 1 && input[0] instanceof import_state.Transaction ? input : input.length == 1 && Array.isArray(input[0]) ? input[0] : [this.state.update(...input)];
    ...
    */
    update(transactions) {
      ...
      if (state.facet(import_state.EditorState.phrases) != this.state.facet(import_state.EditorState.phrases))
      ...
      try {
        ...
        for (let tr of transactions) {
          ...
          if (tr.scrollIntoView) {
            ...
            scrollTarget = new ScrollTarget(main.empty ? main : import_state.EditorSelection.cursor(main.head, main.head > main.anchor ? -1 : 1), "nearest", "nearest", y, x);
          }
    ...
    */
    visualLineSide(line, end) {
      return end ? import_state.EditorSelection.cursor(line.to, 1) : import_state.EditorSelection.cursor(line.from, -1);
    }
    /**
    ...
    */
    static scrollIntoView(pos, options = {}) {
      var _a, _b, _c, _d;
      return scrollIntoView.of(new ScrollTarget(typeof pos == "number" ? import_state.EditorSelection.cursor(pos) : pos, (_a = options.y) !== null && _a !== void 0 ? _a : "nearest", (_b = options.x) !== null && _b !== void 0 ? _b : "nearest", (_c = options.yMargin) !== null && _c !== void 0 ? _c : 5, (_d = options.xMargin) !== null && _d !== void 0 ? _d : 5));
    }
    /**
    ...
    */
    scrollSnapshot() {
      ...
      return scrollIntoView.of(new ScrollTarget(import_state.EditorSelection.cursor(ref.from), "start", "start", ref.top - scrollTop, scrollLeft, true));
    }
    /**
    ...
    */
    static baseTheme(spec) {
      return import_state.Prec.lowest(styleModule.of(buildTheme("." + baseThemeID, spec, lightDarkIDs)));
    }
    /**
  ...
  EditorView.cursorScrollMargin = /* @__PURE__ */ import_state.Facet.define({
    combine: (inputs) => {
      let x = 5, y = 5;
      for (let i of inputs) {
        if (typeof i == "number")
  ...
  EditorView.cspNonce = /* @__PURE__ */ import_state.Facet.define({ combine: (values) => values.length ? values[0] : "" });
  EditorView.contentAttributes = contentAttributes;
  EditorView.editorAttributes = editorAttributes;
  EditorView.lineWrapping = /* @__PURE__ */ EditorView.contentAttributes.of({ "class": "cm-lineWrapping" });
  EditorView.announce = /* @__PURE__ */ import_state.StateEffect.define();
  ...
  var handleKeyEvents = /* @__PURE__ */ import_state.Prec.default(/* @__PURE__ */ EditorView.domEventHandlers({
    keydown(event, view) {
      return runHandlers(getKeymap(view.state), event, view, "editor");
    }
  }));
  var keymap = /* @__PURE__ */ import_state.Facet.define({ enables: handleKeyEvents });
  ...
  function runHandlers(map, event, view, scope) {
    ...
    let charCode = (0, import_state.codePointAt)(name, 0), isChar = (0, import_state.codePointSize)(charCode) == name.length && name != " ";
  ...
  var layerOrder = /* @__PURE__ */ import_state.Facet.define();
  ...
  var selectionConfig = /* @__PURE__ */ import_state.Facet.define({
    combine(configs) {
    ...
    markers(view) {
      ...
      for (let r of state.selection.ranges) {
        ...
        if (r.empty || conf.drawRangeCursor && !(prim && browser.ios && conf.iosSelectionHandles)) {
          ...
          let cursor = r.empty ? r : import_state.EditorSelection.cursor(r.head, r.assoc);
  ...
  var selectionLayer = /* @__PURE__ */ layer({
    ...
    markers(view) {
      ...
      if (browser.ios && !main.empty && view.state.facet(selectionConfig).iosSelectionHandles) {
        for (let piece of RectangleMarker.forRange(view, "cm-selectionHandle cm-selectionHandle-start", import_state.EditorSelection.cursor(main.from, 1)))
          markers.push(piece);
        for (let piece of RectangleMarker.forRange(view, "cm-selectionHandle cm-selectionHandle-end", import_state.EditorSelection.cursor(main.to, 1)))
          markers.push(piece);
      }
      return markers;
    },
  ...
  var hideNativeSelection = /* @__PURE__ */ import_state.Prec.highest(/* @__PURE__ */ EditorView.theme({
    ".cm-line": {
  ...
  var setDropCursorPos = /* @__PURE__ */ import_state.StateEffect.define({
    map(pos, mapping) {
      return pos == null ? null : mapping.mapPos(pos);
    }
  });
  var dropCursorPos = /* @__PURE__ */ import_state.StateField.define({
    create() {
      return null;
    },
    update(pos, tr) {
  ...
  var MatchDecorator = class {
    ...
    */
    createDeco(view) {
      let build = new import_state.RangeSetBuilder(), add2 = build.add.bind(build);
  ...
  var specialCharConfig = /* @__PURE__ */ import_state.Facet.define({
    combine(configs) {
      let config = (0, import_state.combineConfig)(configs, {
        render: null,
      ...
      makeDecorator(conf) {
        return new MatchDecorator({
          ...
          decoration: (m, view, pos) => {
            ...
            let code = (0, import_state.codePointAt)(m[0], 0);
            if (code == 9) {
              let line = doc2.lineAt(pos);
              let size = view.state.tabSize, col = (0, import_state.countColumn)(line.text, size, pos - line.from);
              return Decoration.replace({
    ...
    if (a.off > MaxOff || b.off > MaxOff || a.col < 0 || b.col < 0) {
      ...
      for (let i = startLine; i <= endLine; i++) {
        ...
        if (line.length <= endOff)
          ranges.push(import_state.EditorSelection.range(line.from + startOff, line.to + endOff));
      }
    } else {
      let startCol = Math.min(a.col, b.col), endCol = Math.max(a.col, b.col);
      for (let i = startLine; i <= endLine; i++) {
        let line = state.doc.line(i);
        let start = (0, import_state.findColumn)(line.text, startCol, state.tabSize, true);
        if (start < 0) {
          ranges.push(import_state.EditorSelection.cursor(line.to));
        } else {
          let end = (0, import_state.findColumn)(line.text, endCol, state.tabSize);
          ranges.push(import_state.EditorSelection.range(line.from + start, line.from + end));
        }
      }
    }
    return ranges;
  ...
  function getPos(view, event) {
    ...
    let col = off > MaxOff ? -1 : off == line.length ? absoluteColumn(view, event.clientX) : (0, import_state.countColumn)(line.text, view.state.tabSize, offset - line.from);
    ...
    return {
      ...
      get(event2, _extend, multiple) {
        ...
        if (!ranges.length)
          return startSel;
        if (multiple)
          return import_state.EditorSelection.create(ranges.concat(startSel.ranges));
        else
          return import_state.EditorSelection.create(ranges);
      }
    };
  }
  ...
  var tooltipConfig = /* @__PURE__ */ import_state.Facet.define({
    combine: (values) => {
      var _a, _b, _c;
      return {
  ...
  var showTooltip = /* @__PURE__ */ import_state.Facet.define({
    enables: [tooltipPlugin, baseTheme]
  });
  var showHoverTooltip = /* @__PURE__ */ import_state.Facet.define({
  ...
  var hoverPlugin = /* @__PURE__ */ import_state.Facet.define();
      ...
      update(value, tr) {
        ...
        if (tr.docChanged && value.length) {
          ...
          for (let tooltip of value) {
            let newPos = tr.changes.mapPos(tooltip.pos, -1, import_state.MapMode.TrackDel);
            if (newPos != null) {
  ...
  var closeHoverTooltipEffect = /* @__PURE__ */ import_state.StateEffect.define();
  ...
  var panelConfig = /* @__PURE__ */ import_state.Facet.define({
    combine(configs) {
  ...
  var showPanel = /* @__PURE__ */ import_state.Facet.define({
    enables: panelPlugin
  });
  function showDialog(view, config) {
    ...
    if (view.state.field(dialogField, false)) {
      ...
      view.dispatch({ effects: import_state.StateEffect.appendConfig.of(dialogField.init(() => [panelCtor])) });
    }
  ...
  var dialogField = /* @__PURE__ */ import_state.StateField.define({
    create() {
      return [];
    },
    update(dialogs, tr) {
  ...
  var openDialogEffect = /* @__PURE__ */ import_state.StateEffect.define();
  var closeDialogEffect = /* @__PURE__ */ import_state.StateEffect.define();
  ...
  var gutterLineClass = /* @__PURE__ */ import_state.Facet.define();
  var gutterWidgetClass = /* @__PURE__ */ import_state.Facet.define();
  var defaults = {
    class: "",
  ...
  var activeGutters = /* @__PURE__ */ import_state.Facet.define();
  function gutter(config) {
    return [gutters(), activeGutters.of(__spreadValues(__spreadValues({}, defaults), config))];
  }
  var unfixGutters = /* @__PURE__ */ import_state.Facet.define({
    combine: (values) => values.some((x) => x)
  });
  ...
  var gutterView = /* @__PURE__ */ ViewPlugin.fromClass(class {
    ...
    syncGutters(detach) {
      ...
      let lineClasses = import_state.RangeSet.iter(this.view.state.facet(gutterLineClass), this.view.viewport.from);
      let classSet = [];
    ...
    updateGutters(update) {
      ...
      let change = update.docChanged || update.heightChanged || update.viewportChanged || !import_state.RangeSet.eq(update.startState.facet(gutterLineClass), update.state.facet(gutterLineClass), update.view.viewport.from, update.view.viewport.to);
      if (prev == cur) {
        for (let gutter2 of this.gutters)
  ...
  var lineNumberMarkers = /* @__PURE__ */ import_state.Facet.define();
  var lineNumberWidgetMarker = /* @__PURE__ */ import_state.Facet.define();
  var lineNumberConfig = /* @__PURE__ */ import_state.Facet.define({
    combine(values) {
      return (0, import_state.combineConfig)(values, { formatNumber: String, domEventHandlers: {} }, {
  ...
  // js/entries/view.js
  globalThis.__CM__view = dist_exports;
})();
