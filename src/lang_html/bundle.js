(() => {
  ...
  // js/shims/codemirror-lang-css.js
  var require_codemirror_lang_css = __commonJS({
    "js/shims/codemirror-lang-css.js"(exports, module) {
      module.exports = globalThis.__CM__lang_css;
    }
  });

  // js/shims/codemirror-lang-javascript.js
  var require_codemirror_lang_javascript = __commonJS({
    "js/shims/codemirror-lang-javascript.js"(exports, module) {
      module.exports = globalThis.__CM__lang_javascript;
    }
  });
  ...
  var import_lr = __toESM(require_lezer_lr(), 1);
  ...
  // node_modules/@codemirror/lang-html/dist/index.js
  var import_lang_css = __toESM(require_codemirror_lang_css(), 1);
  var import_lang_javascript = __toESM(require_codemirror_lang_javascript(), 1);
  ...
  function htmlCompletionFor(schema, context) {
    let { state, pos } = context, tree = (0, import_language.syntaxTree)(state).resolveInner(pos, -1), around = tree.resolve(pos);
  ...
  var jsonParser = /* @__PURE__ */ import_lang_javascript.javascriptLanguage.parser.configure({ top: "SingleExpression" });
  var defaultNesting = [
    {
      tag: "script",
      attrs: (attrs) => attrs.type == "text/typescript" || attrs.lang == "ts",
      parser: import_lang_javascript.typescriptLanguage.parser
    },
    {
      tag: "script",
      attrs: (attrs) => attrs.type == "text/babel" || attrs.type == "text/jsx",
      parser: import_lang_javascript.jsxLanguage.parser
    },
    {
      tag: "script",
      attrs: (attrs) => attrs.type == "text/typescript-jsx",
      parser: import_lang_javascript.tsxLanguage.parser
    },
    {
      tag: "script",
      attrs(attrs) {
    ...
    },
    {
      ...
      parser: import_lang_javascript.javascriptLanguage.parser
    },
    {
      tag: "style",
      attrs(attrs) {
      ...
      parser: import_lang_css.cssLanguage.parser
    }
  ];
  var defaultAttrs = /* @__PURE__ */ [
    {
      name: "style",
      parser: /* @__PURE__ */ import_lang_css.cssLanguage.parser.configure({ top: "Styles" })
    }
  ].concat(/* @__PURE__ */ eventAttributes.map((name) => ({ name, parser: import_lang_javascript.javascriptLanguage.parser })));
  var htmlPlain = /* @__PURE__ */ import_language.LRLanguage.define({
    name: "html",
    parser: /* @__PURE__ */ parser.configure({
      props: [
        ...
        /* @__PURE__ */ import_language.bracketMatchingHandle.add({
  ...
  function html(config = {}) {
    ...
    return new import_language.LanguageSupport(lang, [
      ...
      (0, import_lang_javascript.javascript)().support,
      (0, import_lang_css.css)().support
    ]);
  }
  ...
  var autoCloseTags = /* @__PURE__ */ import_view.EditorView.inputHandler.of((view, from, to, text, insertTransaction) => {
    ...
    let closeTags = state.changeByRange((range) => {
      ...
      let { head } = range, after = (0, import_language.syntaxTree)(state).resolveInner(head, -1), name;
  ...
  // js/entries/lang_html.js
  globalThis.__CM__lang_html = dist_exports2;
  globalThis.__CM__lezer_html = dist_exports;
})();
