...
let () =
  ...
  (* and the page's own inputs, which the check typed into *)
  El.set_prop El.Prop.value (Jstr.v "fox") query_input;
  El.set_prop El.Prop.value (Jstr.v "FOX") replace_input;
  report ()
